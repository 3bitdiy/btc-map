...
function editorPage(session, env) {
  ...
  const html =
    ...
    `.role.owner{background:#ff4326;color:#fff}.role.admin{background:#1c1c1c;color:#fff}.role.organizer{background:transparent;border:1px solid rgba(28,28,28,.3);color:#1c1c1c}` +
